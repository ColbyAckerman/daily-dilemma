...
//
// NOISE_RATE = 0.07 — a touch below the 0.10 of the noisy-IPD tournament
// studies (2005 noisy category, won by DBS). Always applied: enough per-round
// flips over a short match that forgiving strategies (Generous TfT, Contrite
// TfT, Pavlov) pull ahead of rigid ones, without the game feeling capricious.
// ---------------------------------------------------------------------------
export const NOISE_RATE = 0.07;
