...
export const NAMED = [
  ...
  },
  {
    ...
    blurb: 'Defected every round, unconditionally.',
  ...
  },
  {
    ...
    blurb: 'Cooperated until your first defection — then defected forever.',
    origin: 'Grim / Friedman — Axelrod 1980',
    first: () => 'C', move: grim,
  },
  {
    id: 'slow-anger', name: 'Slow to Anger', nice: true,
    blurb: 'Only retaliated after you defected twice in a row.',
  ...
  },
  {
    ...
    blurb: 'Opened with a defection, then mirrored you from there.',
    origin: 'Suspicious Tit for Tat',
    first: () => 'D', move: (s, foe, r) => foe[r - 1],
  },
  {
    id: 'forgiving', name: 'Generous Tit for Tat', nice: true,
    blurb: 'Mirrored you, but forgave about a third of your defections — the level Nowak & Sigmund proved optimal.',
  ...
  },
  {
    ...
    blurb: 'Answered every one of your defections with two of its own.',
  ...
  },
  {
    ...
    blurb: 'Cooperated until your third defection — then defected forever.',
    origin: null,
    first: () => 'C', move: (s, foe) => (countD(foe) >= 3 ? 'D' : 'C'),
  },
  {
    id: 'probe', name: 'The Probe', nice: false,
    blurb: 'Tested you with an early defection — then exploited you for not hitting back, or settled into mirroring if you did.',
  ...
  },
  {
    ...
    blurb: 'Ignored you completely and alternated Cooperate, Defect.',
    origin: null,
    first: () => 'C', move: (s) => (s[s.length - 1] === 'C' ? 'D' : 'C'),
  },
  {
    id: 'three-beat', name: 'Three-Beat', nice: false,
    blurb: 'Ran a fixed loop: Cooperate, Cooperate, Defect.',
    origin: null,
  ...
  },
  {
    ...
    blurb: 'Defected unless you had clearly cooperated more than you defected.',
  ...
  },
  {
    ...
    blurb: 'Mirrored you, but always broke a defection spiral by cooperating first.',
    origin: null,
    first: () => 'C',
  ...
  },
  {
    ...
    blurb: 'Cooperated only with players who echoed its secret opening: Defect, then Cooperate.',
  ...
  },
  {
    ...
    blurb: 'Cooperated freely; retaliated only the round after its own cooperation was defected.',
  ...
  },
  {
    ...
    blurb: 'Mirrored you, but slipped in a free defection every seventh round.',
  ...
  },
  {
    ...
    blurb: 'Cooperated while ahead on points, defected to catch up when behind.',
    origin: null,
    first: () => 'C',
    move: (s, foe, r) => {
      let me = 0;
  ...
  },
  {
    ...
    blurb: 'Went hostile after your first defection, but three straight cooperations won it back.',
    origin: null,
    first: () => 'C',
    move: (s, foe, r) => {
  ...
  // --- historical additions ---
  {
    ...
    blurb: 'Built a statistical model of how you react, and defected while it was still uncertain about you.',
  ...
  },
  {
    ...
    blurb: 'Punished your nth defection with n retaliations, then offered two cooperations to reset.',
  ...
  },
  {
    ...
    blurb: 'Cooperated whenever you two had agreed last round, defected whenever you had clashed.',
    origin: 'Grofman — Bernard Grofman, Axelrod 1980',
    first: () => 'C', move: (s, foe, r) => (s[r - 1] === foe[r - 1] ? 'C' : 'D'),
  },
  {
    id: 'fader', name: 'The Fader', nice: false,
    blurb: 'Started as pure Tit-for-Tat, then grew steadily more likely to defect as the game wore on.',
  ...
  },
  {
    ...
    blurb: 'Played fair Tit-for-Tat — with one surprise inspection defection midway through.',
  ...
  },
  {
    ...
    blurb: 'Skimmed a defection off your cooperation on a schedule, forcing you into a losing ratio.',
  ...
  },
  {
    ...
    blurb: 'Decided each move from the pattern of the last three rounds — punished two or more defections in that window.',
  ...
  },
  {
    ...
    blurb: 'Opened by defecting, then held a permanent grudge against any defection of yours.',
  ...
  },
  {
    ...
    blurb: 'Extremely forgiving — cooperated until your fifth defection, then defected for good.',
    origin: null,
    first: () => 'C', move: (s, foe) => (countD(foe) >= 5 ? 'D' : 'C'),
  },
  {
    id: 'trend-follower', name: 'The Trend Follower', nice: true,
    blurb: 'Copied your last move when you were consistent, and defected whenever you wavered.',
    origin: null,
    first: () => 'C',
  ...
  },
  {
    ...
    blurb: 'Almost a total pushover — with one inexplicable defection early on.',
    origin: null,
  ...
  // --- the noise era: strategies built to survive mistakes ---
  {
    ...
    blurb: 'Mirrored you, but tracked whose fault a defection was — and apologised with a cooperation whenever it had slipped first.',
    origin: 'Contrite Tit for Tat — Boyd (1989), Wu & Axelrod (1995); the noise-robust fix for Tit-for-Tat spirals',
    first: () => 'C',
    move: (s, foe, r) => {
      if (r === 0) return 'C';
      // if last round it defected while you cooperated, it "owes" an apology
  ...
  },
  {
    ...
    blurb: 'Tit-for-Tat with two safety valves: it breaks out of a Cooperate/Defect see-saw, and goes permanently hostile if you start looking random.',
  ...
  },
  {
    ...
    blurb: 'Played Tit-for-Tat but slipped in a small unprovoked defection now and then, just to see what it could get away with.',
  ...
  },
  {
    ...
    origin: 'Remorseful Prober — a probing Tit-for-Tat that distinguishes its own probes from your defections',
    first: () => 'C',
    move: (s, foe, r, rng) => {
...
const ARCHETYPES = [
  {
    ...
    describe: (p) => {
      const parts = [];
      parts.push(p.open === 'D' ? 'Opened with a defection.' : 'Opened by cooperating.');
      parts.push(
        p.patience === 1
          ? 'Retaliated as soon as you defected'
          : `Retaliated only after ${p.patience} of your defections in a row`
      );
  ...
  },
  {
    ...
    describe: (p) => {
      const lead = p.open === 'D' ? 'Opened by defecting, then cooperated' : 'Cooperated';
      let s = `${lead} until your ${ordinal(p.threshold)} defection, then defected`;
  ...
  },
  {
    ...
    describe: (p) => {
      ...
      return p.hard
        ? `Defected unless ${span} showed a clear cooperation majority.`
    ...
    describe: (p) => {
      ...
      const no =
        p.ifNot === 'allD'
          ...
          : p.ifNot === 'sneak'
          ? 'regular sneak defections'
          : 'frequent needling defections';
  ...
  },
  {
    ...
    describe: (p) => {
      if (p.mode === 'ahead') return 'Watched the scoreboard — cooperated while ahead, defected to catch up when behind.';
      if (p.mode === 'within')
        return `Cooperated while the score stayed within ${p.margin} points either way, and defected once the gap widened.`;
  ...
  },
  {
    ...
    describe: (p) =>
      `${p.base === 'tft' ? 'Mirrored you' : 'Cooperated'}, but slipped in a free defection every ${
        p.every
      } rounds.`,
  },
  {
  ...
  },
  {
    ...
    describe: (p) =>
      `${p.open === 'D' ? 'Opened by defecting. ' : ''}Punished you whenever your last ${
        p.window
      } moves held ${p.trigger} or more defections.`,
  },
];
...
function phase(k) {
  return { tft: 'Tit-for-Tat', allC: 'unconditional cooperation', allD: 'unconditional defection', grim: 'a permanent grudge' }[k];
}
...
// ===========================================================================
// Family — the behavioural bucket a strategy sits in, for the post-game reveal.
// Worked out by playing the strategy against a handful of canned player lines.
// ===========================================================================
export const FAMILIES = {
  fixed: [
    'Fixed pattern',
    'It runs the same script no matter what you do. Spot the pattern, then take it apart.',
  ],
  wildcard: [
    'Wildcard',
    'It plays at random — nothing you do moves it. Just bank the safe points and hope.',
  ],
  reciprocator: [
    'Reciprocator',
    'It hands back exactly what you give. Cooperate and it cooperates; one hit earns one hit.',
  ],
  grudger: [
    'Grudge-holder',
    'One defection and it turns on you, often for good. The rule here: never strike first.',
  ],
  forgiver: [
    'Forgiver',
    'It answers a defection but comes back to cooperation fast — a stray hit won’t spiral.',
  ],
  prober: [
    'Prober',
    'It slips in unprovoked defections to see what it can get away with. Answer every one.',
  ],
  exploiter: [
    'Exploiter',
    'It defects the moment it senses you’re soft. Show teeth early or it runs you over.',
  ],
  calculator: [
    'Calculator',
    'It decides from running tallies and a model of you, not your last move. Steady play throws it least.',
  ],
};

function playOut(strat, foeSeq) {
  const rng = mulberry32(0x1234);
  const self = [];
  const foe = [];
  for (let r = 0; r < foeSeq.length; r++) {
    const mv = r === 0 ? strat.first(rng) : strat.move(self, foe, r, rng);
    self.push(mv === 'D' ? 'D' : 'C');
    foe.push(foeSeq[r]);
  }
  return self;
...
// the opponent's moves against a fixed player line — noise-free reference
export function oppMovesVs(oppRef, foeSeq) {
  return playOut(resolveOpponent(oppRef), foeSeq);
}

function classifyFamily(strat, archKey) {
  if (archKey === 'scorekeeper' || archKey === 'reader') return 'calculator';

  const N = 16;
  const line = (fn) => Array.from({ length: N }, (_, i) => fn(i));
  const allC = line(() => 'C');
  const oneD = line((i) => (i === 3 ? 'D' : 'C'));
  const alt = line((i) => (i % 2 ? 'D' : 'C'));
  const allD = line(() => 'D');

  const sC = playOut(strat, allC);
  const sOneD = playOut(strat, oneD);
  const sAlt = playOut(strat, alt);
  const sD = playOut(strat, allD);

  const same = (a, b) => a.join('') === b.join('');
  if (same(sC, sD) && same(sC, sOneD) && same(sC, sAlt)) return 'fixed';

  const dInC = sC.filter((m) => m === 'D').length;
  if (dInC >= N * 0.4) return 'exploiter';
  if (dInC >= 1) return 'prober';

  // "nice" so far — judge by how it handles one defection at round 3
  const punishedAt = sOneD.indexOf('D', 4);
  if (punishedAt < 0) return 'forgiver';
  const returned = sOneD.slice(punishedAt + 1).includes('C');
  const tailPeace = sOneD.slice(10).every((m) => m === 'C');
  if (!returned || !tailPeace) return 'grudger';

  let mirror = 0;
  for (let r = 1; r < N; r++) if (sAlt[r] === alt[r - 1]) mirror++;
  const punishLen = sOneD.slice(punishedAt).join('').replace(/C.*$/s, '').length;
  if (mirror >= N - 3 && punishLen <= 2) return 'reciprocator';
  return 'forgiver';
}

// a few named strategies the behavioural sniff-test buckets wrong
const FAMILY_OVERRIDE = {
  random: 'wildcard',
  'win-stay': 'forgiver',
  probe: 'prober',
  'naive-prober': 'prober',
  'remorseful-prober': 'prober',
  modeler: 'calculator',
  accountant: 'calculator',
  historian: 'calculator',
  auditor: 'calculator',
  gambler: 'exploiter',
  extortionist: 'exploiter',
  tranquilizer: 'exploiter',
  colluder: 'exploiter',
};

export function familyOf(oppRef) {
  const o = resolveOpponent(oppRef);
  const key =
    FAMILY_OVERRIDE[o.id] ||
    (o.arch === 'pavlov' ? 'forgiver' : classifyFamily(o, o.arch));
  const [name, hint] = FAMILIES[key];
