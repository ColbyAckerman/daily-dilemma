...
export const NAMED = [
  ...
  {
    id: 'forgiving', name: 'Forgiving Mirror', nice: true,
    blurb: 'Mirrored you, but let roughly 1 in 5 of your defections slide.',
    origin: 'Generous Tit for Tat — Nowak & Sigmund (1992)',
    first: () => 'C',
    move: (s, foe, r, rng) => {
      const last = foe[r - 1];
      if (last === 'D' && rng() < 0.2) return 'C';
      return last;
    },
  },
  {
